...
const HeroSection = () => {
  return (
    <section
      id="rhc-section"
      className="relative overflow-hidden pt-6 md:pt-10 pb-12 md:pb-20 bg-white scroll-mt-24"
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        <div className="relative z-10">
          ...
          <h1
            className="
            font-extrabold text-[60px] leading-[0.8] sm:text-[80px] md:text-[100px]  lg:text-[110px] tracking-tighter mb-4 w-full md:whitespace-nowrap"
          >
            Rizqiya <br className="md:hidden" />
            <span className="text-primary">Home Care</span>
          </h1>

          <div className="absolute top-[80px] md:top-[140px] -left-10 -z-10">
            <Image
